import { Award, Code, Gift, BarChart4, Megaphone, ShieldCheck } from "lucide-react"
...
export function ServicesSection() {
    ...
    return (
        <section id="services" className="w-full py-12 md:py-24 lg:py-32 services-section">
            <div className="container px-4 md:px-6">
                <div className="flex flex-col items-center justify-center space-y-4 text-center">
                    <div className="space-y-2">
                        <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Our Services</h2>
                        <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                            We offer a complete suite of promotional marketing solutions to help your brand stand out.
                        </p>
                    </div>
                </div>
